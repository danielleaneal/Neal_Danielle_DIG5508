...
# 
# A *factorial* is defined as the product of an integer and all of the positive integers below it.
#The Factorial of 0 is 1.
# If the argument is a float, then throw a value error.
#%% [markdown]
# # 1: factorial()
